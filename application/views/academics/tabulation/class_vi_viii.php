    ...
    <table class="GridTable" style="width:98%; margin-top:20px; margin-left:10px;">
        <tbody>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["unit_test_marks"]["physics"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["unit_test_marks"]["chemistry"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["unit_test_marks"]["biology"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["unit_test_marks"]["history"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["unit_test_marks"]["geography"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <?php if(in_array($class["name"], ["VI", "VII"])) { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["unit_test_marks"]["subject_10_marks"] ?></td>
                <?php } else { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["unit_test_marks"]["subject_10_marks"] ?>(<?php echo $student["subject"]["name"][0] ?>)</td>
                <?php } ?>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_marks"]["physics"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_marks"]["chemistry"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_marks"]["biology"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_marks"]["history"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_marks"]["geography"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <?php if(in_array($class["name"], ["VI", "VII"])) { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_marks"]["subject_10_marks"] ?></td>
                <?php } else { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_marks"]["subject_10_marks"] ?>(<?php echo $student["subject"]["name"][0] ?>)</td>
                <?php } ?>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["totals"]["physics"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["totals"]["chemistry"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["totals"]["biology"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["totals"]["history"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["totals"]["geography"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <?php if(in_array($class["name"], ["VI", "VII"])) { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["totals"]["subject_10_marks"] ?></td>
                <?php } else { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["totals"]["subject_10_marks"] ?>(<?php echo $student["subject"]["name"][0] ?>)</td>
                <?php } ?>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["avgs"]["english"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["english"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["avgs"]["second_language"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["second_language"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["avgs"]["mathematics"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["mathematics"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["avgs"]["pcb"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["pcb"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["avgs"]["hg"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["hg"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["avgs"]["subject_10_marks"] ?></td>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["grade_subjects"]["third_language"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["total_avg"] ?></td>
                ...
                <td class="Tdc" style="width:3%"><?php if($student["eligible_for_rank"]) { echo array_search($student["total_avg"], $ranks) + 1; } ?></td>
