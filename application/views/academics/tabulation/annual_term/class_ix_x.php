    ...
    <table class="GridTable" style="width:98%; margin-top:20px; margin-left:10px;">
        <tbody>
            <tr>
                ...
                <th class="Thc" style="width:3%">PT</th>
                <th class="Thc" style="width:4%">OPT1</th>
                <th class="Thc" style="width:3%">PT</th>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:4%"><?php echo $student["second_unit_test_marks"]["subject_10_marks"] ?>(<?php echo $student["subject"]["name"][0] ?>)</td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:4%"><?php echo $student["annual_term_marks"]["subject_10_marks"] ?>(<?php echo $student["subject"]["name"][0] ?>)</td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:4%"><?php echo $student["annual_term_totals"]["subject_10_marks"] ?>(<?php echo $student["subject"]["name"][0] ?>)</td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:4%"><?php echo $student["annual_term_avg"]["subject_10_marks"] ?>(<?php echo $student["subject"]["name"][0] ?>)</td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:4%"><?php echo $student["first_term_avg"]["subject_10_marks"] ?>(<?php echo $student["subject"]["name"][0] ?>)</td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php if(($student["is_absent"] == false) && ($student["passed"] == true)) { echo $student["division"]; }?></td>
