    ...
    <table class="GridTable" style="width:98%; margin-top:20px; margin-left:10px;">
        <tbody>
            <tr>
                ...
                <th class="Thc" style="width:3%">PCB</th>
                <th class="Thc" style="width:3%">PT</th>
                <th class="Thc" style="width:3%;">HIS</th>
                <th class="Thc" style="width:3%">GEO</th>
                <th class="Thc" style="width:3%">HG</th>
                <th class="Thc" style="width:3%">PT</th>
                <?php if(in_array($class["name"], ["VI", "VII"])) { ?>
                ...
                <th class="Thc" style="width:3%">TL</th>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["second_unit_test_marks"]["second_language"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["second_unit_test_marks"]["mathematics"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["second_unit_test_marks"]["history"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["second_unit_test_marks"]["geography"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <?php if(in_array($class["name"], ["VI", "VII"])) { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["second_unit_test_marks"]["subject_10_marks"] ?></td>
                <?php } else { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["second_unit_test_marks"]["subject_10_marks"] ?>(<?php echo $student["subject"]["name"][0] ?>)</td>
                <?php } ?>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_marks"]["second_language"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_marks"]["mathematics"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_marks"]["history"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_marks"]["geography"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <?php if(in_array($class["name"], ["VI", "VII"])) { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_marks"]["subject_10_marks"] ?></td>
                <?php } else { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_marks"]["subject_10_marks"] ?>(<?php echo $student["subject"]["name"][0] ?>)</td>
                <?php } ?>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_totals"]["second_language"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_totals"]["mathematics"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_totals"]["history"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_totals"]["geography"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <?php if(in_array($class["name"], ["VI", "VII"])) { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_totals"]["subject_10_marks"] ?></td>
                <?php } else { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_totals"]["subject_10_marks"] ?>(<?php echo $student["subject"]["name"][0] ?>)</td>
                <?php } ?>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_avg"]["second_language"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_avg"]["mathematics"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_avg"]["pcb"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_avg"]["hg"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <?php if(in_array($class["name"], ["VI", "VII"])) { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_avg"]["subject_10_marks"] ?></td>
                <?php } else { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_avg"]["subject_10_marks"] ?>(<?php echo $student["subject"]["name"][0] ?>)</td>
                <?php } ?>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student['annual_term_grade_subjects']['moral_science'] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student['annual_term_grade_subjects']['catechism'] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student['annual_term_grade_subjects']['third_language'] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_avg"]["second_language"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_avg"]["mathematics"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_avg"]["pcb"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_avg"]["hg"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <?php if(in_array($class["name"], ["VI", "VII"])) { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_avg"]["subject_10_marks"] ?></td>
                <?php } else { ?>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_avg"]["subject_10_marks"] ?>(<?php echo $student["subject"]["name"][0] ?>)</td>
                <?php } ?>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student['first_term_grade_subjects']['moral_science'] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student['first_term_grade_subjects']['catechism'] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student['first_term_grade_subjects']['third_language'] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["final_avg"]["second_language"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["second_language"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["final_avg"]["mathematics"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["mathematics"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["final_avg"]["pcb"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["pcb"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["final_avg"]["hg"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["hg"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["final_avg"]["subject_10_marks"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["subject_10_marks"] ?></td>
                ...
                <td class="Tdc" style="width:3%">
                    <?php   
                                    if($student['first_term_grade_subjects']['third_language'] == "") {
                                        echo $student['annual_term_grade_subjects']['third_language'];
                                    }
                                    elseif($student['annual_term_grade_subjects']['third_language'] == "") {
                                        echo $student['first_term_grade_subjects']['third_language'];
                                    }
                                    else{
                                        echo $student['first_term_grade_subjects']['third_language'] < $student['annual_term_grade_subjects']['third_language'] ? $student['first_term_grade_subjects']['third_language'] : $student['annual_term_grade_subjects']['third_language']; 
                                    }    
                                ?>
                </td>
                <td class="Tdc" style="width:3%"><?php echo $student["final_avg_total"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["total_point"] ?></td>
                <td class="Tdc" style="width:3%"><?php if($student["is_absent"] == false) { echo $student["passed"] ? $student["division"] : ""; }?></td>
                <td class="Tdc" style="width:3%"><?php if($student["is_absent"] == false) { echo $student["passed"] ? "P" : "UN"; } ?></td>
                <td class="Tdc" style="width:3%"><?php if($student["is_absent"] == false) { if($student["eligible_for_rank"] && $student["passed"]) { echo array_search($student["final_avg_total"], $ranks) + 1; } }?></td>
