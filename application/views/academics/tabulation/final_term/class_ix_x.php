    ...
    <table class="GridTable" style="width:98%; margin-top:20px; margin-left:10px;">
        <tbody>
            <tr>
                ...
                <th colspan="3" class="Thc" style="width:2%;">P+C+B</th>
                <th colspan="3" class="Thc" style="width:2%;">H/C+G</th>
                <th colspan="3" class="Thc" style="width:2%;">Comp App</th>
                <th colspan="3" class="Thc" style="width:2%;">Eco App</th>
                <th colspan="3" class="Thc" style="width:2%;">P.Ed</th>
            ...
            <?php foreach($records as $student) { $i++; ?>
                <tr>
                  ...
                  <td class="Tdc" style="width:10% !important;"><?php echo $student['name'] ?></td>
                      ...
                      <td class="Tdc"><?php echo $student['english_avg'] ?></td>
                      ...
                      <!--Comp App-->
                      <?php if($student['group_3_subjects']['g3s1'] == "Computer Application") { ?>
                      <td class="Tdc"><?php echo $student['group_3_final_totals']['g3s1'] ?></td>
                      <td class="Tdc"><?php echo $student['group_3_mid_totals']['g3s1'] ?></td>
                      <td class="Tdc"><?php echo $student['group_3_annual_marks']['g3s1'] ?></td>
                      <?php } else { ?>
                      <td class="Tdc">N/A</td>
                      <td class="Tdc">N/A</td>
                      <td class="Tdc">N/A</td>
                      ...
                      <!--Eco App-->
                      <?php if($student['group_3_subjects']['g3s1'] == "Economic Application") { ?>
                      <td class="Tdc"><?php echo $student['group_3_final_totals']['g3s1'] ?></td>
                      <td class="Tdc"><?php echo $student['group_3_mid_totals']['g3s1'] ?></td>
                      <td class="Tdc"><?php echo $student['group_3_annual_marks']['g3s1'] ?></td>
                      <?php } else { ?>
                      ...
                      <!--P.Ed-->
                      <?php if($student['group_3_subjects']['g3s1'] == "Physical Education") { ?>
                      <td class="Tdc"><?php echo $student['group_3_final_totals']['g3s1'] ?></td>
                      <td class="Tdc"><?php echo $student['group_3_mid_totals']['g3s1'] ?></td>
                      <td class="Tdc"><?php echo $student['group_3_annual_marks']['g3s1'] ?></td>
                      <?php } else { ?>
