    ...
    <table class="GridTable" style="width:98%; margin-top:20px; margin-left:10px;">
        <tbody>
            <tr>
                ...
                <th colspan="3" class="Thc" style="width:2%;">English</th>
                <th colspan="3" class="Thc" style="width:2%;">2nd Lang</th>
                <th colspan="3" class="Thc" style="width:2%;">Maths</th>
                <th colspan="3" class="Thc" style="width:2%;">Physics</th>
                <th colspan="3" class="Thc" style="width:2%;">Chemistry</th>
                <th colspan="3" class="Thc" style="width:2%;">Biology</th>
                <th colspan="3" class="Thc" style="width:2%;">Hist/Civ</th>
                <th colspan="3" class="Thc" style="width:2%;">Geog</th>
                ...
                <th colspan="3" class="Thc" style="width:2%;">3rd Lang</th>
            ...
            <?php foreach($records as $student) { $i++; ?>
                <tr>
                  ...
                  <td class="Tdc" style="width:10% !important;"><?php echo $student['name'] ?></td>
                      ...
                      <td class="Tdc"><?php echo $english_avg ?></td>
                      ...
                      <!--Hist/Civ-->
                      <td class="Tdc"><?php echo $student['final_totals']['s8'] ?></td>
                      <td class="Tdc"><?php echo $student['mid_totals']['s8'] ?></td>
                      <td class="Tdc"><?php echo $student['annual_marks']['s8'] ?></td>
                      
                      <!--Geog-->
                      <td class="Tdc"><?php echo $student['final_totals']['s9'] ?></td>
                      <td class="Tdc"><?php echo $student['mid_totals']['s9'] ?></td>
                      <td class="Tdc"><?php echo $student['annual_marks']['s9'] ?></td>
                      
                      <!--Comp Std-->
                      <td class="Tdc"><?php echo $student['final_totals']['s10'] ?></td>
                      <td class="Tdc"><?php echo $student['mid_totals']['s10'] ?></td>
                      <td class="Tdc"><?php echo $student['annual_marks']['s10'] ?></td>
                      ...
                      <!--3rd Lang-->
                      <td class="Tdc"><?php echo $student['special_final_totals']['sps3'] ?></td>
                      <td class="Tdc"><?php echo $student['special_mid_totals']['sps3'] ?></td>
                      <td class="Tdc"><?php echo $student['special_annual_marks']['sps3'] ?></td>
