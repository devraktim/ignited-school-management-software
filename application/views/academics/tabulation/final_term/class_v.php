            ...
            <?php foreach($records as $student) { $i++; ?>
                <tr>
                  ...
                  <td class="Tdc" style="width:10% !important;"><?php echo $student['name'] ?></td>
                      ...
                      <!--Sp & Dict-->
                      <td class="Tdc"><?php echo $student['special_final_totals']['sps4'] ?></td>
                      <td class="Tdc"><?php echo $student['special_mid_totals']['sps4'] ?></td>
                      <td class="Tdc"><?php echo $student['special_annual_marks']['sps4'] ?></td>
