                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td rowspan="2"><?php echo $student["percentage"]["english"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["percentage"]["second_language"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["percentage"]["mathematics"] ?></td>
                            <td class="text-start">Relays messages correctly</td>
                            <td><?php echo $student["evolution_grades"][3] ?></td>
                        </tr>
                        <tr>
                            <td class="text-start">Science</td>
                            <td><?php echo $student["unit_test_marks"]["science"] ?></td>
                            <td><?php echo $student["first_term_marks"]["science"] ?></td>
                            <td><?php echo $student["totals"]["science"] ?></td>
                            <td><?php echo $student["percentage"]["science"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["unit_test_marks"]["social_studies"] ?></td>
                            <td><?php echo $student["first_term_marks"]["social_studies"] ?></td>
                            <td><?php echo $student["totals"]["social_studies"] ?></td>
                            <td><?php echo $student["percentage"]["social_studies"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["unit_test_marks"]["computer"] ?></td>
                            <td><?php echo $student["first_term_marks"]["computer"] ?></td>
                            <td><?php echo $student["totals"]["computer"] ?></td>
                            <td><?php echo $student["percentage"]["computer"] ?></td>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td><?php echo $student['grade_subjects']['gk'] ?></td>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td><?php echo $student['grade_subjects']['handwriting'] ?></td>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td><?php echo $student['grade_subjects']['drawing'] ?></td>
                            <td></td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3"></td>
                            <td><strong><?php echo $student["total_percentage"] ?></strong></td>
                            <td></td>
                            <td></td>
                        </tr>
                    </tbody>
                ...
                <div class="row justify-content-between my-2">
                    <div class="col-md-2 d-flex justify-content-center">
                        <table>
                            <tr>
                                <td>Percentage</td>
                                <td><?php echo number_format($student["total_avg_percentage"]) ?>%</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="col-md-2 d-flex justify-content-center">
                        <table>
                            <tr>
                                <td>Ranks</td>
                                <td><?php if($student["eligible_for_rank"]) { echo array_search($student["total_percentage"], $ranks) + 1; } ?></td>
                            </tr>
                        </table>
                    </div>
