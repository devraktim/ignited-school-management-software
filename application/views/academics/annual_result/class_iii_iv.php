                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo $student["unit_test2_marks"]["english_language"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["unit_test2_marks"]["english_literature"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["unit_test2_marks"]["second_language"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["unit_test2_marks"]["mathematics"] ?></td>
                        ...
                        <tr>
                            <td class="text-start">EVS</td>
                            <td><?php echo $student["unit_test2_marks"]["evs"] ?></td>
                            <td><?php echo $student["annual_term_marks"]["evs"] ?></td>
                            <td><?php echo $student["totals"]["evs"] ?></td>
                            <td><?php echo $student["percentage"]["evs"] ?></td>
                            <td><?php echo $student["percentage"]["evs"] ?></td>
                            <td><?php echo $student["percentage"]["evs"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["unit_test2_marks"]["computer"] ?></td>
                ...
                <div class="row justify-content-between my-2">
                    <div class="col-md-2 d-flex justify-content-center">
                        <table>
                            <tr>
                                <td>Percentage</td>
                                <td><?php echo number_format($student["total_percentage"] / 5) ?>%</td>
                            </tr>
                        </table>
                    </div>
