    ...
    <table class="GridTable" style="width:98%; margin-top:20px; margin-left:10px;">
        <tbody>
            <tr>
                ...
                <th class="Thc" style="width:3%">PT</th>
                <th class="Thc" style="width:3%">POL</th>
                <th class="Thc" style="width:3%">PT</th>
                <th class="Thc" style="width:3%">SOC</th>
                <th class="Thc" style="width:3%">PT</th>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["unit_test_marks"]["political_science"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["unit_test_marks"]["sociology"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["unit_test_marks"]["optional_paper_1"] ?>(<?php echo $student["optional_papers"][0]["name"][0] ?>)</td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["unit_test_marks"]["optional_paper_2"] ?>(<?php echo $student["optional_papers"][1]["name"][0] ?>)</td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_marks"]["political_science"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_marks"]["sociology"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_marks"]["optional_paper_1"] ?>(<?php echo $student["optional_papers"][0]["name"][0] ?>)</td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_marks"]["optional_paper_2"] ?>(<?php echo $student["optional_papers"][1]["name"][0] ?>)</td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["totals"]["political_science"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["totals"]["sociology"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["totals"]["optional_paper_1"] ?>(<?php echo $student["optional_papers"][0]["name"][0] ?>)</td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"><?php echo $student["totals"]["optional_paper_2"] ?>(<?php echo $student["optional_papers"][1]["name"][0] ?>)</td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["avgs"]["history"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["history"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["avgs"]["political_science"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["political_science"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["avgs"]["sociology"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["sociology"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["avgs"]["optional_paper_1"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["points"]["optional_paper_1"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["avgs"]["optional_paper_2"] ?></td>
                ...
                <td class="Tdc" style="width:3%"><?php if($student["has_ab"] == "YES" || $student["passed"] == false) {echo "";} else { echo $student["division"][0]; }?></td>
                <?php if($student["has_ab"] == "YES") { ?>
                    <td class="Tdc" style="width:3%">I</td>
                <?php }else { ?>
                    <td class="Tdc" style="width:3%"><?php echo $student["passed"] ? "P" : "U" ?></td>
                <?php } ?>
