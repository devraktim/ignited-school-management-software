...
<body onload="javascript:setValues()">
    ...
    <table class="GridTable" style="width:98%; margin-top:20px; margin-left:10px;">
        <tbody>
            ...
            <tr>
                <td class="Tdc" style="width:2%" rowspan="8"><?php echo $i; ?></td>
                <td class="Tdc" style="width:6%" rowspan="8"><?php echo $student['student_no'] ?></td>
                <td class="Tdc" style="width:6%" rowspan="8"><?php echo $student['name'] ?></td>
            </tr>
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["second_unit_test_marks"]["science"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["second_unit_test_marks"]["social_studies"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["second_unit_test_marks"]["computer"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_marks"]["science"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_marks"]["social_studies"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_marks"]["computer"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_totals"]["science"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_totals"]["social_studies"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_totals"]["computer"] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_avg"]["science"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_avg"]["social_studies"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_avg"]["computer"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student['annual_term_grade_subjects']['gk'] ?></td>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student['annual_term_grade_subjects']['handwriting'] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student['annual_term_grade_subjects']['third_language'] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student['annual_term_grade_subjects']['drawing'] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_avg"]["science"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_avg"]["social_studies"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_avg"]["computer"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student['first_term_grade_subjects']['gk'] ?></td>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student['first_term_grade_subjects']['handwriting'] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student['first_term_grade_subjects']['third_language'] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student['first_term_grade_subjects']['drawing'] ?></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
                <td class="Tdc" style="width:3%"></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["final_avg"]["science"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["final_avg"]["social_studies"] ?></td>
                <td class="Tdc" style="width:3%"><?php echo $student["final_avg"]["computer"] ?></td>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["final_percentage"] ?></td>
                <td class="Tdc" style="width:3%"><?php if($student["is_absent"] == false) { echo $student["division"]; } ?></td>
