    ...
    <table class="GridTable" style="width:98%; margin-top:20px; margin-left:10px;">
        <tbody>
            <tr>
                ...
                <th class="Thc" style="width:3%">EVS</th>
                ...
                <th class="Thc" style="width:3%">Draw</th>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["second_unit_test_marks"]["evs"] ?></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_marks"]["evs"] ?></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_totals"]["evs"] ?></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["annual_term_avg"]["evs"] ?></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_avg"]["evs"] ?></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["final_avg"]["evs"] ?></td>
