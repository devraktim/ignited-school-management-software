    ...
    <table class="GridTable" style="width:98%; margin-top:20px; margin-left:10px;">
        <tbody>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["unit_test_marks"]["evs"] ?></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["first_term_marks"]["evs"] ?></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["totals"]["evs"] ?></td>
            ...
            <tr>
                ...
                <td class="Tdc" style="width:3%"><?php echo $student["percentage"]["evs"] ?></td>
                ...
                <td class="Tdc" style="width:3%"><?php echo number_format($student["total_percentage"] / 5) ?></td>
