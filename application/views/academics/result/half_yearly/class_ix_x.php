...
<head>
    ...
    <title>Half Yearly Progress Report</title>
...
<body>
    ...
    <div class="a4-page">
        ...
        <div class="report-title">
            HALF YEARLY PROGRESS REPORT <?php echo (date('Y', strtotime($currentSession['start'])) == date('Y', strtotime($currentSession['end']))) ? date('Y', strtotime($currentSession['start'])) : date('Y', strtotime($currentSession['start'])) . '-' . date('Y', strtotime($currentSession['end'])); ?><br>
        ...
        <div style="padding: 10px;">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $english_i_total = $student['english_i_total'];
                    $english_ii_total = $student['english_ii_total'];
                    $english_avg = $student['english_combined_total'];
                    $english_grade = getGrade($english_avg);
                    ?>
                    
                    <!-- English I -->
                    <tr>
                        <td><?= $student['subjects']['s1'] ?></td>
                        <td class="text-center"><?= $student['unit_test_marks']['s1'] ?></td>
                        <td class="text-center"><?= $student['mid_term_marks']['s1'] ?></td>
                        <td class="text-center"><?= $student['totals']['s1'] ?></td>
                    ...
                    <!-- English II -->
                    <tr>
                        <td><?= $student['subjects']['s2'] ?></td>
                        <td class="text-center"><?= $student['unit_test_marks']['s2'] ?></td>
                        <td class="text-center"><?= $student['mid_term_marks']['s2'] ?></td>
                        <td class="text-center"><?= $student['totals']['s2'] ?></td>
                    </tr>
                    ...
                    <?php foreach ([3, 4] as $id): ?>
                        <?php
                            ...
                            $ut1 = $student['unit_test_marks']["s$id"];
                            $mid = $student['mid_term_marks']["s$id"];
                            $total = $student['totals']["s$id"];
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= $student['unit_test_marks']['s5'] ?></td>
                        <td class="text-center"><?= $student['mid_term_marks']['s5'] ?></td>
                        <td class="text-center"><?= $student['totals']['s5'] ?></td>
                        <td class="text-center" rowspan="3"><?= $student['science_avg'] ?></td>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= $student['unit_test_marks']['s6'] ?></td>
                        <td class="text-center"><?= $student['mid_term_marks']['s6'] ?></td>
                        <td class="text-center"><?= $student['totals']['s6'] ?></td>
                    </tr>
                    
                    <!-- Biology -->
                    <tr>
                        <td><?= $student['subjects']['s7'] ?></td>
                        <td class="text-center"><?= $student['unit_test_marks']['s7'] ?></td>
                        <td class="text-center"><?= $student['mid_term_marks']['s7'] ?></td>
                        <td class="text-center"><?= $student['totals']['s7'] ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= $student['unit_test_marks']['s8'] ?></td>
                        <td class="text-center"><?= $student['mid_term_marks']['s8'] ?></td>
                        <td class="text-center"><?= $student['totals']['s8'] ?></td>
                        <td class="text-center" rowspan="2"><?= $student['social_avg'] ?></td>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= $student['unit_test_marks']['s9'] ?></td>
                        <td class="text-center"><?= $student['mid_term_marks']['s9'] ?></td>
                        <td class="text-center"><?= $student['totals']['s9'] ?></td>
                    </tr>
                    ...
                    <?php if (!empty($student['group_3_subject_type_ids'])): ?>
                        <tr>
                            ...
                            <th class="text-center">UT1 (100)</th>
                            <th class="text-center">MID T (100)</th>
                        ...
                        <?php foreach ($student['group_3_subject_type_ids'] as $index => $id): ?>
                            <?php
                                $key = "g3s" . ($index + 1);
                                $subject_name = $student['group_3_subjects'][$key] ?? 'Group 3 Subject';
                                $ut1 = $student['group_3_unit_test_marks'][$key];
                                $mid = $student['group_3_mid_term_marks'][$key];
                                $total = $student['group_3_totals'][$key];
                                $grade = getGrade($total);
                            ?>
                            <tr>
                                <td><?= $subject_name ?></td>
                                <td class="text-center"><?= displayMark($ut1) ?></td>
                                <td class="text-center"><?= displayMark($mid) ?></td>
                    ...
                    <?php if (!empty($student['special_subject_type_ids'])): ?>
                        ...
                        <?php foreach ($student['special_subject_type_ids'] as $index => $id): ?>
                            <?php
                                ...
                                $ut1 = $student['special_unit_test_marks'][$key];
                                $mid = $student['special_mid_term_marks'][$key];
                                $total = $student['special_totals'][$key];
