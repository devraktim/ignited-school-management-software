        ...
        <div style="padding: 10px;">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $english_avg = $student['english_combined_total'] ?? 0;
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= $student['unit_test_marks']['s1'] ?? 0 ?></td>
                        <td class="text-center"><?= $student['mid_term_marks']['s1'] ?? 0 ?></td>
                        <td class="text-center"><?= $student['totals']['s1'] ?? 0 ?></td>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?= $student['unit_test_marks']['s2'] ?? 0 ?></td>
                        <td class="text-center"><?= $student['mid_term_marks']['s2'] ?? 0 ?></td>
                        <td class="text-center"><?= $student['totals']['s2'] ?? 0 ?></td>
                    </tr>
