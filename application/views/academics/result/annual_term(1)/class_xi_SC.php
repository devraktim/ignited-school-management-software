    ...
    <?php foreach($students as $student) { ?>
        <div class="container-fluid">
            <div class="result">
                ...
                <h5 class="text-center text-dark font-weight-bold">XI-SCIENCE</h5>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td rowspan="2"><?php echo $student["first_term_avg"]["english"] == 0 ? "AB" : $student["first_term_avg"]["english"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["annual_term_avg"]["physics"] ?></td>
                            <td><?php echo $student["first_term_avg"]["physics"] == 0 ? "AB" : $student["first_term_avg"]["physics"] ?></td>
                            <td><?php echo $student["final_avg"]["physics"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["annual_term_avg"]["chemistry"] ?></td>
                            <td><?php echo $student["first_term_avg"]["chemistry"] == 0 ? "AB" : $student["first_term_avg"]["chemistry"]  ?></td>
                            <td><?php echo $student["final_avg"]["chemistry"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["annual_term_avg"]["biology"] ?></td>
                            <td><?php echo $student["first_term_avg"]["biology"] == 0 ? "AB" : $student["first_term_avg"]["biology"] ?></td>
                            <td><?php echo $student["final_avg"]["biology"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["first_term_avg"]["optional_paper_1"]  == 0 ? "AB" : $student["first_term_avg"]["optional_paper_1"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["first_term_avg"]["optional_paper_2"] == 0 ? "AB" : $student["first_term_avg"]["optional_paper_2"] ?></td>
