                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["second_unit_test_marks"]["physics"] ?></td>
                            <td><?php echo $student["annual_term_marks"]["physics"] ?></td>
                            <td><?php echo $student["annual_term_totals"]["physics"] ?></td>
                            <td rowspan="3"><?php echo $student["annual_term_avg"]["pcb"] ?></td>
                            <td rowspan="3"><?php echo $student["first_term_avg"]["pcb"] ?></td>
                            <td rowspan="3"><?php echo $student["final_avg"]["pcb"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["second_unit_test_marks"]["chemistry"] ?></td>
                            <td><?php echo $student["annual_term_marks"]["chemistry"] ?></td>
                            <td><?php echo $student["annual_term_totals"]["chemistry"] ?></td>
                            <td class="text-start">Takes leader roles</td>
                            <td><?php echo $student["evolution_grades"][5] ?></td>
                        </tr>
                        <tr>
                            <td class="text-start">Biology</td>
                            <td><?php echo $student["second_unit_test_marks"]["biology"] ?></td>
                            <td><?php echo $student["annual_term_marks"]["biology"] ?></td>
                            <td><?php echo $student["annual_term_totals"]["biology"] ?></td>
                        ...
                        <tr>
                            ...
                            <td rowspan="2"><?php echo $student["annual_term_avg"]["hg"] ?></td>
                            <td rowspan="2"><?php echo $student["first_term_avg"]["hg"] ?></td>
                            <td rowspan="2"><?php echo $student["final_avg"]["hg"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["second_unit_test_marks"]["geography"] ?></td>
                            <td><?php echo $student["annual_term_marks"]["geography"] ?></td>
                            <td><?php echo $student["annual_term_totals"]["geography"] ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $student["second_unit_test_marks"]["subject_10_marks"] ?></td>
                            <td><?php echo $student["annual_term_marks"]["subject_10_marks"] ?></td>
                            <td><?php echo $student["annual_term_totals"]["subject_10_marks"] ?></td>
                            <td><?php echo $student["annual_term_avg"]["subject_10_marks"] ?></td>
                            <td><?php echo $student["first_term_avg"]["subject_10_marks"] ?></td>
                            <td><?php echo $student["final_avg"]["subject_10_marks"] ?></td>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td><?php echo $student['annual_term_grade_subjects']['third_language'] ?></td>
                            <td><?php echo $student['first_term_grade_subjects']['third_language'] ?></td>
                            <td>
                                <?php   
                ...
                <div class="row justify-content-between my-2">
                    ...
                    <div class="col-md-2 d-flex justify-content-center">
                        <table>
                            <tr>
                                <td>Ranks</td>
                                <td><?php if($student["is_absent"] == false) { if($student["eligible_for_rank"] && $student["passed"]) { echo array_search($student["final_avg_total"], $ranks) + 1; } }?></td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="col-md-2 d-flex justify-content-center">
                        <table>
                            <tr>
                                <td>Division</td>
                                <td><?php if($student["is_absent"] == false) { echo $student["passed"] ? $student["division"] : ""; }?></td>
                            </tr>
                        </table>
                    </div>
