<?php $this->load->view("inc/app_header.php"); ?>
    ...
    <div class="card card-flush h-xl-100 mb-5">
        <div class="card-body py-9">
            <form action="<?php echo base_url() ?>academics/exam-attendence-entry" method="POST">
                <div class="row">
    ...
    <?php if(isset($students)) { ?>
        <?php if(count($students) > 0) { ?>
            <form action="<?php echo base_url()?>academics/exam-attendence-store/" method="POST">
                <div class="row">
                    <div class="col-md-8">
                                            ...
                                            <?php $i = 0;foreach($students as $student) { $i++; ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="number" class="form-control" name="present[]" value="<?php echo $student['present'] ?>" />  
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                        ...
                        <div class="card card-flush h-xl-100">
                            <div class="card-body py-9">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="total_days" value="<?php echo $total_days; ?>">
                                </div>
                            </div>
                        </div>
                </div>
                ...
                <?php if($this->session->user['permissions'][0]['academics_module'] != "VIEWER") { ?>
                    <?php if($class_teacher_can_enter_attendance == '1') { ?>
    ...
    <script>
        $("#class_id").change(function(event) {
            ...
            fetch("<?php echo base_url('academics/exam-attendence-entry?class_id=') ?>" + $("#class_id").val())
