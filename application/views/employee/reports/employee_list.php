...
<html lang="en">
    ...
    <body data-new-gr-c-s-check-loaded="14.1098.0" data-gr-ext-installed="">
        ...
        ?>
            ...
            <div class="BigHeader" style="width:90%; margin: 0 auto; margin-top:20px">Employee List</div>
            ...
            <table class="GridTable" style="width:94%; margin: 0 auto; margin-top:30px">
                <tbody>
                        <tr>
                            ...
                            <th class="Thc">DOB</th>
                            <th class="Thc">Date Of Joining</th>
                            <th class="Thc">Department</th>
                            <th class="Thc">Designation</th>
                            <th class="Thc">Employee Type</th>
                        ...
                        <?php foreach($records as $record) { $sl_no++ ?>
                            <tr>
                                ...
                                <td class="Tdc"><?php echo $departments[$record['department_id']]['name']; ?></td>
                                <td class="Tdc"><?php echo $designations[$record['department_id']]['name']; ?></td>
                                <td class="Tdc"><?php echo $employee_types[$record['emp_type_id']]['name']; ?></td>
                                <td class="Tdc"><?php echo $job_statuses[['job_status_id']]['name']; ?></td>
