            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link" href="<?php echo base_url() ?>personnel/attendance/month-wise-report">
                                ...
                                <span class="menu-title">Month wise report</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link" href="<?php echo base_url() ?>personnel/attendance/session-wise-report">
                                ...
                                <span class="menu-title">Session wise report</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link" href="https://ignitedsoft.in/stfrancis/personnel/resign-retire-list">
                                ...
                                <span class="menu-title">Retire & Resign List</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link" href="<?php echo base_url() ?>fees/reports">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Reports</span>
