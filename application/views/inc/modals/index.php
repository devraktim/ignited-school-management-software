							...
							<div class="mh-375px scroll-y me-n7 pe-7">
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="#" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary"><?php echo $this->session->user['username'] ?> 
								...
								<div data-kt-search-element="suggestions">
									...
									<div class="mh-375px scroll-y me-n7 pe-7">
										...
										<a href="#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
											...
											<!--begin::Info-->
											<div class="fw-semibold">
												<span class="fs-6 text-gray-800 me-2"><?php echo $this->session->user['username'] ?></span>
									...
									<div class="mh-375px scroll-y me-n7 pe-7">
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="2">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2"><?php echo $this->session->user['username'] ?></a>
													<div class="fw-semibold text-muted">max@kt.com</div>
												</div>
												<!--end::Details-->
											</div>
