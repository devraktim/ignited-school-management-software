...
<head>
	...
	<title>Multiple Visa Letter 1 For Non Indian Student</title>
</head>
<body>
<body data-new-gr-c-s-check-loaded="14.1098.0" data-gr-ext-installed="">
		<div style="width:90%; margin: 0 auto; margin-top:150px;">
			...
			<div style="font-size:12pt; margin-top:30px; text-align:justify; line-height:25px;">
				...
				<?php echo $gender1 ?> Father/ Mother/ Grandfather - mother/ Guardian / Brother / Sister have to come to school for the vacation specified by the school 
					according to the School ST. Joseph's Convent School to take their child.<p></p>
								
				
				Mother : <?php echo $mother ?><br>
				Passport No : <?php echo $mother_passport_no; ?><p></p>
