...
<head>
    ...
    <title>Non Indian Existing Student Bonafide</title>
</head>
<body>
		...
		<div style="width:90%; margin: 0 auto; margin-top:150px;">
			...
			<div style="font-size:12pt; margin-top:30px; text-align:justify; line-height:25px;">
				...
				<?php echo $sex?> of <span style="text-transform:uppercase"> <?php echo $father; ?></span>
				 and <span style="text-transform:uppercase"><?php echo $mother ?></span>				, resident of <span style="text-transform:uppercase"> <?php echo $address; ?></span>, is a bonafide student of this institution and studying in Class
