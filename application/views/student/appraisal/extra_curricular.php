...
?>
    ...
    <div class="row mb-5">
        <h1>Appraisal Extra Curricular</h1>
    </div>

    <div class="card card-flush h-xl-100">
        <div class="card-body py-9">
            <form action="<?php echo base_url() ?>students/reports/generate-appraisal-extra-curricular" method="GET">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="form-group">
                            <label class="form-label">Participated In</label>
                            <select class="form-select" name="participated_in">
                                <option value="">Select</option>
                                
                                <?php foreach($extra_curriculars as $extra_curricular) { ?>
    ...
    <div class="card card-flush h-xl-100">
        <div class="card-body py-9">
            <div class="row">
                <form id="form" method="POST" action="<?php echo base_url() ?>students/reports/appraisal-extra-curricular">
