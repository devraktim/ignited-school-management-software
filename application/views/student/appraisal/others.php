...
?>
    ...
    <div class="row mb-5">
        <h1>Appraisal Others</h1>
    </div>

    <div class="card card-flush h-xl-100">
        <div class="card-body py-9">
            <form action="<?php echo base_url() ?>students/reports/generate-appraisal-others" method="GET">
                <div class="row">
    ...
    <div class="card card-flush h-xl-100">
        <div class="card-body py-9">
            <div class="row">
                <form id="form" method="POST" action="<?php echo base_url() ?>students/reports/appraisal-others">
                            ...
                            <tbody>
                                <?php $i = 0; foreach($records as $record) { $i++; ?>
                                    <tr>
                                        ...
                                        <!--</td>-->
                                        <td>
                                            <input type="text" class="form-control" name="particular[]" value="<?php echo $record['particular'] ?>" />
                                        </td>
                                        <td>
