...
<html lang="en">
    ...
    <body data-new-gr-c-s-check-loaded="14.1098.0" data-gr-ext-installed="">
        ...
        ?>
            ...
            <div class="BigHeader" style="width:90%; margin: 0 auto; margin-top:20px">Student DOB List <?php echo date('Y', strtotime($this->session->academy_session['current_session']['start'])) ?></div>
