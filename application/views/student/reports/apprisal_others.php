...
<html lang="en">
    ...
    <body data-new-gr-c-s-check-loaded="14.1098.0" data-gr-ext-installed="">
        ...
        ?>
            ...
            <div class="BigHeader" style="width:90%; margin: 0 auto; margin-top:20px">Apprisal Others List <?php echo date('Y', strtotime($this->session->academy_session['current_session']['start'])) ?></div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="Tdc">
                                <?php echo $student['data']['particular']; ?>
                            </td>
                          
                            <td class="Tdc">
                                <?php echo $student['data']['remarks']; ?>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
