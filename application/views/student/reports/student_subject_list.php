...
<html lang="en">
    ...
    <body data-new-gr-c-s-check-loaded="14.1098.0" data-gr-ext-installed="">
        ...
        ?>
            ...
            <div class="BigHeader" style="width:90%; margin: 0 auto; margin-top:20px">Student Subject List <?php echo date('Y', strtotime($this->session->academy_session['current_session']['start'])) ?></div>
            ...
            <table class="GridTable" style="width:94%; margin: 0 auto; margin-top:30px">
                <thead>
                    <tr>
                        ...
                        <th class="Thc">Class-Section</th>
                        <th class="Thc">Subject Type</th>
                ...
                <tbody>
                    ...
                    foreach ($rows as $student) {
                        $rowspan = count($student['subjects']);
                        $sl_no++;
                        ?>
                        <tr>
                            ...
                            <td class="Tdc" rowspan="<?php echo $rowspan; ?>"><?php echo $student['name']; ?></td>
                            <td class="Tdc" rowspan="<?php echo $rowspan; ?>">
                                <?php echo $class_map[$student['student_session_class_id']]; ?>-<?php echo $section_map[$student['student_session_section_id']]; ?>
                            </td>
                            <?php
                            // Output the first subject
                            $first_subject = array_shift($student['subjects']);
                            ?>
                            <td class="Tdc"><?php echo $first_subject['subject_type']; ?></td>
                            <td class="Tdc"><?php echo $first_subject['subject']; ?></td>
                        </tr>
                        <?php
                        // Output the remaining subjects
                        foreach ($student['subjects'] as $sub) {
                            ?>
                            <tr>
                                <td class="Tdc"><?php echo $sub['subject_type']; ?></td>
                                <td class="Tdc"><?php echo $sub['subject']; ?></td>
                            </tr>
                            <?php
                        }
                    }
