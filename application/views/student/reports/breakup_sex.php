...
<html lang="en">
    ...
    ?>
        ...
        ?>
            ...
            <div class="BigHeader" style="width:90%; margin: 0 auto; margin-top:20px">Sex Wise Breakup <?php echo date('Y', strtotime($this->session->academy_session['current_session']['start'])) ?></div>
