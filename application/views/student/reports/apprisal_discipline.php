...
<html lang="en">
    ...
    <body data-new-gr-c-s-check-loaded="14.1098.0" data-gr-ext-installed="">
        ...
        ?>
            ...
            <div class="BigHeader" style="width:90%; margin: 0 auto; margin-top:20px">Apprisal Discipline List <?php echo date('Y', strtotime($this->session->academy_session['current_session']['start'])) ?></div>
            ...
            <table class="GridTable" style="width:94%; margin: 0 auto; margin-top:30px">
                <thead>
                    <tr>
                        ...
                        <th class="Thc">Conduct</th>
                        <th class="Thc">Behaviour</th>
                        <th class="Thc">Punctuality</th>
                        <th class="Thc">Attendance</th>
                        <th class="Thc">Interaction</th>
                        <th class="Thc">Leadership</th>
                        <th class="Thc">Expressiveness</th>
                        <th class="Thc">Participation</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="Tdc">
                                <?php echo $student['data']['conduct_name']; ?>
                            </td>
                          
                            <td class="Tdc">
                                <?php echo $student['data']['behaviour_name']; ?>
                            </td>
                            
                            <td class="Tdc">
                                <?php echo $student['data']['punctuality_name']; ?>
                            </td>
                            
                            <td class="Tdc">
                                <?php echo $student['data']['attendance_name']; ?>
                            </td>
                            
                            <td class="Tdc">
                                <?php echo $student['data']['leadership_name']; ?>
                            </td>
                            
                            <td class="Tdc">
                                <?php echo $student['data']['interaction_name']; ?>
                            </td>
                            
                            <td class="Tdc">
                                <?php echo $student['data']['expressiveness_name']; ?>
                            </td>
                            
                            <td class="Tdc">
                                <?php echo $student['data']['participation_name']; ?>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
