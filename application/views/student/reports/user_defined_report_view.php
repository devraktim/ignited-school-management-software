                ...
                <tbody>
                        <tr>
                            ...
                            <?php 
                                foreach($fields as $field) { 
                                    ...
                                    if($p[0] == "subjecttype") {
                                        $field = $this->SubjectType->get($p[1])['name'];
                                    }
                                    else {
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="Tdc"><?php echo $student['f_name'] . ' ' . $student['m_name'] . ' ' . $student['l_name']; ?></td>
                                <td class="Tdc"><?php echo $student['student_no']; ?></td>
                                <td class="Tdc"><?php echo $class_map[$student['class_id']] . '-' . $section_map[$student['section_id']]; ?></td>
                                
                                <?php foreach($fields as $field) { ?>
                                    <?php if($field == "class_of_admission") { ?>
                                        <td class="Tdc"><?php  echo $class_map[$student[$field]]; ?></td>
                                    <?php } else { ?>
                                        <td class="Tdc"><?php  echo $student[$field]; ?></td>
                                    <?php } ?>
                                <?php } ?>
