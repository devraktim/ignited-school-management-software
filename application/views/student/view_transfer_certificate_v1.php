...
<!-- NEW ROW : APAAR ID + UDISE PEN -->

<table class="DispTable" style="width:90%; margin-top:10px">

<tr>
<td class="FldL">APAAR ID</td>
<td class="Dta" style="width:35%">
<?php echo isset($data["field_13"]) ? $data["field_13"] : "" ?>
</td>

<td class="FldR">UDISE PEN</td>
<td class="Dta" style="width:35%">
<?php echo isset($data["field_14"]) ? $data["field_14"] : "" ?>
</td>
</tr>
...
<td class="Dta" style="width:10%">
<?php echo $data["field_7"] ?>
</td>

<td class="FldR">class of the</td>

<td class="Dta" style="width:30%">
...
<tr>
<td class="FldL">
All sums due to this school on
<span id="SpnSex3"></span>
account has been remitted or satisfactorily arranged for.
</td>
</tr>
...
<td class="FldL">
<span id="SpnSex4"></span> date of birth, according to the Admission Register, is
</td>
...
(<?php echo date("jS F, Y", strtotime($data["field_11"])) ?>)
</td>
