<?php $this->load->view("inc/app_header.php"); ?>
    <div class="row mb-5">
        <h1>Withdrawn Student List</h1>
    </div>

    <div class="card card-flush h-xl-100">
        <div class="card-body py-9">
            <?php echo form_open(base_url("students/withdrawn-students"), array("method" => "POST")) ?> 
                <div class="row">
                            ...
                            <tbody>
                                <?php $sl_no = 0; foreach($students as $student) { $sl_no++;?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <?php echo form_open(base_url("students/reports/student-biodata"), array("method" => "POST")) ?> 
                                                <input name="student_id" class="d-none" type="text" value="<?php echo $student["student_id"] ?>" />
                                                <button type="submit" class="btn btn-sm btn-primary">Download Biodata</button>
                                            <?php echo form_close() ?>
                                        </td>
                                        <td>
