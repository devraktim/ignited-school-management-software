            ...
            <div class="col-6 border-end border-dashed">
                <div class="receipt">
                    ...
                    <div class="rupees-in-words">
                        <strong>Rupees in words:</strong> <?php echo numberToWord($data['net_amount']); ?>
                    </div>
...
function numberToWord($value) {
    $fraction = round(($value - floor($value)) * 100);
    $fractionText = "";

    if ($fraction > 0) {
        $fractionText = " " . convertNumber($fraction) . " Paise";
    }

    $result = convertNumber(floor($value)) . "" . $fractionText . " Only";
