...
elseif (!empty($month_from) && !empty($month_to) && ($month_from != 1 || $month_to != 12)) {
    ...
    $title_suffix = "Month Range (" . date('M', mktime(0,0,0,$month_from,10)) . " - " . date('M', mktime(0,0,0,$month_to,10)) . ")";
} else {
            ...
            <table style="width:98%; border-collapse:collapse; margin:10px auto;">
                <tr>
                    ...
                    <td style="text-align:center;">
                        ...
                        <div class="BigHeader">Class Wise <?= $title_suffix ?> Collection - Session 2025</div>
                    </td>
