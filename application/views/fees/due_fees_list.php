<?php $this->load->view("inc/app_header.php"); ?>
    <div class="row mb-5">
        <h1>Outstanding Fees Summary</h1>
    </div>

    <div class="card card-flush h-xl-100">
        <div class="card-body py-9">
            <?php echo form_open(base_url("fees/fees-due/index"), array("method" => "GET")) ?> 
                <div class="row">
                            ...
                            <tbody>
                                <?php $sl_no = 0; foreach($students as $student) { $sl_no++; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $student['amount'] ?? 0; ?> INR
                                            
                                            <input type="text" class="form-control d-none" name="student_id[]" value="<?php echo $student['id'] ?>" />
                                            <input type="number" class="form-control d-none amount" name="amount[]" value="<?php if($student['amount'] == "" ) { echo 0; } else { echo $student['amount']; } ?>" />
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
