<?php 
    ...
    class EmployeeReportController extends CI_Controller {
        ...
        //     // Use $_GET to fetch filtering parameters
        //     $clauses = $_GET;
        ...
        //     $selectedYear = isset($filteredClauses['year']) ? (int)$filteredClauses['year'] : null;
        ...
        //             "employee_types"    => $employee_types,
        //             "employeeRecords"   => [],
        //             "attendanceData"    => [] // Pass empty attendance data to the view
        //         ];
        ...
        //             // For each record, get attendance for the specific day
        //             foreach ($records as $record) {
                        
        //                 $attendance = $this->EmployeeAttendance->getAttendanceByEmployeeAndDate($record['id'], $session, $attendanceDate);
                        
        //                 // Count attendance only if present
        //                 if ($attendance) {
        //                     $attendanceData[$monthKey]['totalAttendance']++;
        //                     $attendanceData[$monthKey]['employeeAttendance'][$record['id']][] = $attendanceDate; // Store dates for each employee
        //                 }
